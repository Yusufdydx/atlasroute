    ...
    registerTool(server, _req) {
        server.registerTool("FindDentists", {
            ...
            try {
                ...
                const facilities = yield overpass_1.OverpassUtilities.findNearbyFacilities(geoResult.latitude, geoResult.longitude, searchRadius, ["dentist"]);
                ...
                return mcp_utilities_1.McpUtilities.createTextResponse(JSON.stringify({
                    ...
                    results: results, searchRadius: searchRadius, totalFound: facilities.length, facilityType: "dentist",
...
exports.FindDentistsToolInstance = new FindDentistsTool();
